class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up, keys: [:name]) if params['controller']['owner']
    devise_parameter_sanitizer.permit(:sign_up, keys: %i[name cpf]) if params['controller']['customers']
  end
